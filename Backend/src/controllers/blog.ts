...
const creatBlog = asyncHandler(async (req: CustomRequest, res: Response) => {
...
const allBlogs = asyncHandler(async (req: CustomRequest, res: Response) => {
  ...
  try {
    ...
    followingSet=new Set(
      followingRelationship.map((f)=>(f.followingId))
    )
  }
...
//For BlogDetail page
const getOneBlog = async (req: CustomRequest, res: Response) => {
