...
declare const loggedInUserProfile: (req: CustomRequest, res: Response) => Promise<Response<any, Record<string, any>>>;
declare const loggedInUserBolgs: import("express").RequestHandler<import("express-serve-static-core").ParamsDictionary, any, any, import("qs").ParsedQs, Record<string, any>>;
